module CBS
	...
	def self.etr
		...
		etr = UI::WebDialog.new( 'etr', true, 'etr',400, 500, 222, 222, true )
		path = File.join(File.dirname(__FILE__), "webtool", "etr.html")	
		etr.set_file path # "etr"
		 
		etr.show
		etr.add_action_callback("etr") { |dialog,arg|
			...
			model = Sketchup.active_model
			 ...
			 pts = []
			pts[0] = [1.mm, -2.mm , 0.mm+h3]
			pts[1] = [550.mm-1.mm, -2.mm, 0.mm+h3]
			pts[2] = [550.mm-1.mm, -21.mm, 0.mm+h3]
			pts[3] = [1.mm, -21.mm, 0.mm+h3]
			...
			if result == 6 
				...
				#fronto	   
				 ...
				 pts = []
				pts[0] = [550.mm+1.mm, -2.mm , 0.mm+h1+2.mm+h2]
				pts[1] = [550.mm+x1-1.mm, -2.mm, 0.mm+h1+2.mm+h2]
				pts[2] = [550.mm+x1-1.mm, -21.mm, 0.mm+h1+2.mm+h2]
				pts[3] = [550.mm+1.mm, -21.mm, 0.mm+h1+2.mm+h2]
				...
				#frontu
				 ...
				 pts = []
				pts[0] = [550.mm+1.mm, -2.mm , 0.mm+h1]
				pts[1] = [550.mm+x1-1.mm, -2.mm, 0.mm+h1]
				pts[2] = [550.mm+x1-1.mm, -21.mm, 0.mm+h1]
				pts[3] = [550.mm+1.mm, -21.mm, 0.mm+h1]
				...
				model = Sketchup.active_model
				  ...
				  entities = group2z.entities
					...
					pts = []
				pts[0] = [xx-x1+d1, 0.mm, zz-z1]
				pts[1] = [xx-x1, 0.mm,  zz-z1]
				pts[2] = [xx-x1, yy,  zz-z1]
				pts[3] = [xx-x1+d1, yy,  zz-z1]
				...
				## subo
				  ...
				  entities = group7s.entities
					...
					pts = []
				pts[0] = [xx-x1+d1+37.5.mm, -2.mm, h1+5.mm ]
				pts[1] = [xx-d1-37.5.mm, -2.mm , h1+5.mm ]
				pts[2] = [xx-d1-37.5.mm, -2.mm + ll-24.mm, h1+5.mm ]
				pts[3] = [xx-x1+d1+37.5.mm, -2.mm + ll-24.mm, h1+5.mm ]
				...
				## suru
				  ...
				  entities = group7r.entities
					...
					pts = []
				pts[0] = [xx-x1+d1+43.5.mm, -2.mm+ll-24.mm, h1+5.mm ]
				pts[1] = [xx-d1-43.5.mm, -2.mm+ll-24.mm ,h1+5.mm ]
				pts[2] = [xx-d1-43.5.mm, -2.mm+ll-24.mm+16.mm, h1+5.mm ]
				pts[3] = [xx-x1+d1+43.5.mm, -2.mm+ll-24.mm+16.mm, h1+5.mm ]
