module CBS
	...
	def self.brd
		...
		brd = UI::WebDialog.new( 'brd', true, 'brd',400, 500, 222, 222, true )
		path = File.join(File.dirname(__FILE__), "webtool", "brd.html")	
		brd.set_file path # "brd"
		 
		brd.show
		
		brd.add_action_callback("brd") { |dialog,arg|
			...
			model = Sketchup.active_model
			  ...
			  entities = group1.entities
				...
				pts = []
			pts[0] = [0.mm, 0.mm, 0.mm+z1]
			pts[1] = [d1, 0.mm, 0.mm+z1]
			pts[2] = [d1, yy, 0.mm+z1]
			pts[3] = [0.mm, yy, 0.mm+z1]
			...
			model = Sketchup.active_model
			  ...
			  entities = group3.entities
				...
				pts = []
			pts[0] = [0.mm, 0.mm, 0.mm+zz]
			pts[1] = [0.mm+xx, 0.mm, 0.mm+zz]
			pts[2] = [0.mm+xx, yy, 0.mm+zz]
			pts[3] = [0.mm, yy, 0.mm+zz]
			...
			model = Sketchup.active_model
			  ...
			  entities = group4.entities
				...
				pts = []
			pts[0] = [xx-d1, 0.mm , 0.mm+z1]
			pts[1] = [xx, 0.mm, 0.mm+z1]
			pts[2] = [xx, yy, 0.mm+z1]
			pts[3] = [xx-d1, yy, 0.mm+z1]
