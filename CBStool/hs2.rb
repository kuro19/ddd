module CBS
	...
	def self.hs2
		...
		hs2 = UI::WebDialog.new( 'hs2', true, 'hs2',400, 500, 222, 222, true )
		path = File.join(File.dirname(__FILE__), "webtool", "hs2.html")	
		hs2.set_file path # "hs2"
		 
		hs2.show
		
		hs2.add_action_callback("hs2") { |dialog,arg|
			...
			model = Sketchup.active_model
			  ...
			  entities = group5.entities
				...
				pts = []
			pts[0] = [0.mm, 0.mm+yy, 0.mm]
			pts[1] = [0.mm+xx, 0.mm+yy, 0.mm]
			pts[2] = [0.mm+xx, 0.mm+yy+r1, 0.mm]
			pts[3] = [0.mm, 0.mm+yy+r1, 0.mm]
			...
			if x1 >= 2
				...
				pts[2] = [xx/2-(d1/2)+d1, 0.mm+yy, 0.mm+z1]
				pts[3] = [xx/2-(d1/2), 0.mm+yy, 0.mm+z1]
