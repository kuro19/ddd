module CBS
	...
	def self.box3
		...
		box3 = UI::WebDialog.new( 'box3', true, 'box3',400, 500, 222, 222, true )
		path = File.join(File.dirname(__FILE__), "webtool", "box3.html")	
		box3.set_file path # "box3"
		box3.show
		box3.add_action_callback("box3") { |dialog,arg|
