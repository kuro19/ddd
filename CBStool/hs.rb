module CBS
	...
	def self.hs
		...
		hs = UI::WebDialog.new( 'hs', true, 'hs',400, 500, 222, 222, true )
		path = File.join(File.dirname(__FILE__), "webtool", "hs.html")	
		hs.set_file path # "hs"
		 
		hs.show
		hs.add_action_callback("hs") { |dialog,arg|
			...
			if result == 7 # Yes
				 ...
				 if so != 0
				 group = ent.add_group  group1s, group2s, group3s, group1, group2, group3, group5, group6	
				 else	
				 group = ent.add_group  group1, group2, group3, group5, group6		
				 end
				...
				utf.add_action_callback("utf") { |dialog,arg|
					...
					if so != 0
						ent = Sketchup.active_model.entities
						group = ent.add_group  group1s, group2s, group3s, group1, group2, group3, group5, group6, group7	
					else
						ent = Sketchup.active_model.entities
						group = ent.add_group  group1, group2, group3, group5, group6, group7
					end
					utf.close
				}
